...
ეს არის RESTful API პროექტი, რომელიც შექმნილია **ASP.NET Core 8**-ით. პროექტი აკეთებს მომხმარებლების, პროექტების, ამოცანებისა და კომენტარების მართვას CRUD ოპერაციებით.
